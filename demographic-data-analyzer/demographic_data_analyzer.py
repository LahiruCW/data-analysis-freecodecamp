...
def calculate_demographic_data(print_data=True):
    ...
    min_hour_salary = df[(df['salary']=='>50K') & (df['hours-per-week']==min_work_hours)]
    num_min_workers = df[df['hours-per-week']==min_work_hours].shape[0]
    min_number = min_hour_salary.shape[0]

    rich_percentage = (min_number / num_min_workers) * 100
    ...
    Occu_counts = high_salary_India['occupation'].value_counts()

    top_IN_occupation = Occu_counts.idxmax()
